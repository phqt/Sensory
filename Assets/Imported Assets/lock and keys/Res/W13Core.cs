...
public class W13Core : MonoBehaviour {
    ...
    public static CharacterController CharContrloller;
	...
	static public void FindPlayer () {
		...
		if (Player!=null) {PlayerT = Player.transform;
                           if (Player.GetComponent<CharacterController>()!=null) { CharContrloller = Player.GetComponent<CharacterController>(); }
        }
	}
